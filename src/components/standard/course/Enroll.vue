              ...
              <div class="mt-10 lg:mt-0">
                ...
                <div class="mt-4 rounded-lg border border-gray-200 bg-white shadow-sm">
                  ...
                  <div class="border-t border-gray-200 py-6 px-4 sm:px-6">
                    <button @click="$router.push('/course/thank')" type="button" class="w-full rounded-md border border-transparent bg-indigo-600 py-3 px-4 text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-50">Confirm order</button>
                  </div>
                </div>
              </div>
            </form>
