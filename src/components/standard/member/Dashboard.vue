        ...
        async getProfile() {
            try 
            {
                ...
                this.loading_sources = false;
                    ...
                    const resAPI = await fetch(this.apiServer + "user/profile",
                    {
                        method: 'GET',
                        headers: {
...
<template>
  ...
  <!-- Page header -->
  <div class="mx-auto max-w-3xl px-4 sm:px-6 md:flex md:items-center md:justify-between md:space-x-5 lg:max-w-7xl lg:px-4">
